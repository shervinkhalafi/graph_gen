...
def main():
    ...
    if args.local:
        ...
        from tmgg_modal.stages.stage2 import generate_stage2_configs
    ...
    # Modal execution
    from tmgg_modal.stages.stage2 import run_stage2

    print(f"Starting Stage 2 on Modal with parallelism={args.parallelism}, gpu={args.gpu}")
