"""Tests for wandb_parsing architecture and flag extraction.

Run names derive from YAML config filenames under ``exp_configs/models/``.
Every model config must map to a known architecture label, and modifier
...
import pandas as pd
import pytest
from wandb_parsing import parse_architecture, parse_run_name_fields
