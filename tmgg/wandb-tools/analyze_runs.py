...
Parsing and enrichment are delegated to the co-located ``wandb_parsing``
module.
...
from wandb_parsing import enrich_dataframe
...
def main() -> None:
    ...
    # Enrich with parsed columns (from wandb_parsing).
