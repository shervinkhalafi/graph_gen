...
def main(config: DictConfig) -> Dict[str, Any]:
    ...
    if best_model_path:
        best_model = AttentionDenoisingLightningModule.load_from_checkpoint(best_model_path)
...
def evaluate_across_noise_levels(model: AttentionDenoisingLightningModule,
