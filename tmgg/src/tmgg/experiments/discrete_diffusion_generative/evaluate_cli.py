...
def evaluate_checkpoint(
    ...
    **dataset_kwargs
    ...
    print("\nLoading model...")
    module = DiscreteDiffusionLightningModule.load_from_checkpoint(
    ...
    with torch.no_grad():
        samples = module.sample_batch(batch_size=num_samples, num_nodes=num_nodes)

    # Compute MMD
    print("Computing MMD metrics...")
    mmd_results = evaluate_discrete_samples(
        ref_graphs, samples, kernel=mmd_kernel, sigma=mmd_sigma
    )
