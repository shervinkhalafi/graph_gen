...
-----
```bash
uv run python -m tmgg.experiments.gaussian_diffusion_generative.evaluate_checkpoint \
...
Examples:
  ...
  python -m tmgg.experiments.gaussian_diffusion_generative.evaluate_checkpoint \\
