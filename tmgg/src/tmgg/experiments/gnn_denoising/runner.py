...
from .lightning_module import GNNDenoisingLightningModule
...
def main(config: DictConfig) -> Dict[str, Any]:
    ...
    if best_model_path:
        best_model = GNNDenoisingLightningModule.load_from_checkpoint(best_model_path)
...
def evaluate_across_noise_levels(model: GNNDenoisingLightningModule,
