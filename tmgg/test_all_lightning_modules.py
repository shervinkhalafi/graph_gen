...
from tmgg.experiments.hybrid_denoising.lightning_module import HybridDenoisingLightningModule
from tmgg.experiments.digress_denoising.lightning_module import DigressDenoisingLightningModule
