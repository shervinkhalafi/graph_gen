...
def test_config_loading():
    ...
    try:
        with initialize(config_path=config_path, version_base="1.3"):
            ...
            assert cfg.data.pin_memory == True  # Should come from base_dataloader
...
def test_datamodule_instantiation():
    ...
    try:
        with initialize(config_path="src/tmgg/exp_configs", version_base="1.3"):
            ...
            print(f"  ✓ Setup completed. Train matrices: {len(datamodule.train_adjacency_matrices) if datamodule.train_adjacency_matrices else 0}")
